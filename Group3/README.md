...
```
The s77 represents random seed, which is used to randomly extract the reads. 0.05 means 5% of data will be extracted, and the extracted data will be output to sub_R1.fastq and sub_R2.fastq.
