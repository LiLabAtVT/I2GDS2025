# =================== Paths ===================
seurat_path <- "/projects/intro2gds/I2GDS2025/R_LectureData/Razan_SingleCell/Scripts/Patho_Nonpatho_integration.Rds" # Change the file path to your own directory before running the script.
out_dir <- getwd()
