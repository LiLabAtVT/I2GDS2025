...
Neg1 <- Read10X(data.dir = "/projects/intro2gds/I2GDS2025/R_LectureData/Razan_SingleCell/Matrix_Data/Non_Infected_1_Matrix_File/filtered_feature_bc_matrix")
Neg2 <- Read10X(data.dir = "/projects/intro2gds/I2GDS2025/R_LectureData/Razan_SingleCell/Matrix_Data/Non_Infected_2_Matrix_File/filtered_feature_bc_matrix")
Pos1 <- Read10X(data.dir = "/projects/intro2gds/I2GDS2025/R_LectureData/Razan_SingleCell/Matrix_Data/Infected_1_Matrix_File/filtered_feature_bc_matrix")
Pos2 <- Read10X(data.dir = "/projects/intro2gds/I2GDS2025/R_LectureData/Razan_SingleCell/Matrix_Data/Infected_2_Matrix_File/filtered_feature_bc_matrix")
